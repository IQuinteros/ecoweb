...
<body>
  ...
  <table>
    ...
    ?>
      ...
      <li></li>
      <?php echo " precio :" . $value->price ?>
      <li></li>
      <?php echo "disponible :" . $value->stock . "";

      ?>
      <li></li>
      <?php echo "material : " . $value->form->recycled_mats ?>
      <li></li>
      <?php "producion : " . $value->form->recycled_prod . "";
  ...
  <ul>
    <li><a href="nuevoarticulo.php">nuevo articulo</a></li>
  </ul>
</body>
